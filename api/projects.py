        ...
        try:
            ...
            project = execute_returning(
                ...
                (
                    ...
                    body.get('pipe_diameter', 1000),
                    body.get('layer_width', 600),
                    body.get('layer_thickness', 1.0),
                    body.get('strip_count', 30),
                    body.get('strip_width', 20),
                    body.get('estimated_force', 30000),
                    body.get('location', ''),
                    payload['user_id']
                )
            )
